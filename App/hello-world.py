...
'''
mytitle = dcc.Markdown(children='# Resume Screening')
myinput = dcc.Textarea(
    id='textarea-input',
    value='',
    style={'width': '100%', 'height': 200},
)
mytext = dcc.Markdown(children="", style={'width': '100%', 'height': 200})
# mytext = dcc.Textarea(id='textarea-output', value='', style={'width': '100%', 'height': 300})

# define de app
app.layout = dbc.Container([mytitle, myinput, mytext])
